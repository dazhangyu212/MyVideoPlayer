package com.hisign.video.exception;
...
import com.hisign.video.Log.SysLogBiz;
    ...
    private String saveCrashInfo2File(Throwable ex) {
        ...
        try {
            ...
            if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
                String path = ConstPath.PROJECT_ROOT_PATH + "Log/";
            ...
            SysLogBiz.saveCrashInfoFile(SysLogBiz.getExceptionInfo(e));
            Log.d(TAG, "an error occured while writing file...");
        }
        return null;
    }
}
